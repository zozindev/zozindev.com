...
import { canonicalUrl, postSlug, sortPostsByDate } from "../lib/site";
...
const staticPages = [
  ...
  { path: "/privacy.html", lastmod: "2026-06-11", changefreq: "yearly", priority: "0.3" },
];
